    ...
    <div class="container form-container">
        <form id="formRegistration">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nameRegister" aria-describedby="emailHelp" placeholder="Enter name">
                <small id="nameHelp" class="form-text text-muted">You should use your real name</small>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Email address</label>
                <input type="email" class="form-control" name="emailRegister" aria-describedby="emailHelp" placeholder="Enter email">
